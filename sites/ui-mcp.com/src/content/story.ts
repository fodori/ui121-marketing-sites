...
export const story = parseStory({
  ...
  problemBody: 'Connect any AI to human surfaces via MCP. Real-time, API-first, AI-native human–machine interface.',
  solutionTitle: 'Connect any AI to human surfaces via MCP',
  solutionBody:
