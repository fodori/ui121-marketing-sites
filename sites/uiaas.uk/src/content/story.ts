...
export const story = parseStory({
  ...
  problemBody: "UI as a service for AI-augmented ops. Real-time, API-first, AI-native human–machine interface.",
  solutionTitle: "UI as a service for AI-augmented ops",
