# ui121 — Domain → Positioning Map

> Marketing/landing-page positioning per owned domain. Each domain gets a landing page that leads with its specific angle, all funneling to the ui121 company story.

| Domain                                   | Angle / Positioning                                                             |
| ---------------------------------------- | ------------------------------------------------------------------------------- |
...
- All landing pages funnel to the **ui121** company story.
- `ui1to1.com` is a scaffold/alias (redirect or twin later).
- `helpexpert.me` / `newhuman.store` are deferred to a later build.
