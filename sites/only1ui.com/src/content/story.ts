...
export const story = parseStory({
  ...
  problemBody: "Only one UI channel for AI and workflows. Real-time, API-first, AI-native human–machine interface.",
  solutionTitle: "Only one UI channel for AI and workflows",
