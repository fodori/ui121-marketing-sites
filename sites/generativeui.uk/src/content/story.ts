...
export const story = parseStory({
  ...
  problemBody: 'Generative UI with controlled blocks. Real-time, API-first, AI-native human–machine interface.',
  solutionTitle: 'Generative UI with controlled blocks',
  solutionBody:
