...
export const story = parseStory({
  ...
  problemBody: 'One programmable UI for people and machines. Real-time, API-first, AI-native human–machine interface.',
  solutionTitle: 'One programmable UI for people and machines',
  solutionBody:
