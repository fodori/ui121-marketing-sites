...
export const story = parseStory({
  ...
  problemBody: 'Real-time humans for agents — coming soon. Real-time, API-first, AI-native human–machine interface.',
  solutionTitle: 'Real-time humans for agents — coming soon',
  solutionBody:
