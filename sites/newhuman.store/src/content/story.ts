...
export const story = parseStory({
  ...
  problemBody: 'On-demand humans, automated and real-time. Real-time, API-first, AI-native human–machine interface.',
  solutionTitle: 'On-demand humans, automated and real-time',
  solutionBody:
