...
export const story = parseStory({
  ...
  problemBody: "One UI for every machine-driven surface. Real-time, API-first, AI-native human–machine interface.",
  solutionTitle: "One UI for every machine-driven surface",
